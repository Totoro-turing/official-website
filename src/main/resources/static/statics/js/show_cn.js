...
METUI_FUN['subcolumn_nav_met_11_4_29'] = {
	name: 'subcolumn_nav_met_11_4_29',
	init: function() {
		var m = METUI['subcolumn_nav_met_11_4_29']; //此处对应的最外层的那个css类名
		if(device_type != 'd') $('body').wrapInner('<div class="cover"></div>');
		var nav = METUI['subcolumn_nav_met_11_4_29'].find('.subcolumn-nav'),
			ul = METUI['subcolumn_nav_met_11_4_29'].find('ul'),
			li = ul.find('li'),
...
var x = new metui(METUI_FUN['subcolumn_nav_met_11_4_29']);
var wh = $(window).height();
$('.show_met_11_3_5 [data-plugin=appear]').each(function() {
